...
namespace PMIS.Forms
    {
        public partial class IndicatorValueDataEntryOnDate : Form
        {
            ...
            private IClaimUserOnIndicatorValueService claimUserOnIndicatorValueService;
            private bool isLoaded = false;
            #endregion

            public IndicatorValueForm(IIndicatorValueService _IndicatorValueService, IClaimUserOnIndicatorValueService _claimUserOnIndicatorValueService, IUserService _userService, ILookUpValueService _lookUpValueService)
            {
                InitializeComponent();
