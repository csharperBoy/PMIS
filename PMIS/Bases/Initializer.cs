        ...
        private class DbInitializer : IDbInitializer
        {
            ...
            private void setAllLookUps(PmisContext context)
            {
                ...
                if (!context.LookUps.Any())
                {
                    ...
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Counting:Quantity", Display = "عدد", OrderNum = 2 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Counting:Man", Display = "نفر", OrderNum = 2 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Time:Year", Display = "سال", OrderNum = 2 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Time:Month", Display = "ماه", OrderNum = 2 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Time:Week", Display = "هفته", OrderNum = 2 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Time:Day", Display = "روز", OrderNum = 2 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Time:Hour", Display = "ساعت", OrderNum = 2 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Time:Minute", Display = "دقیقه", OrderNum = 2 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Time:Second", Display = "ثانیه", OrderNum = 2 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Time:MilliSecond", Display = "میلی‌ثانیه", OrderNum = 2 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Action:Man.Hour", Display = "نفر ساعت", OrderNum = 2 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Mass:Ton", Display = "تن", OrderNum = 10 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Mass:KiloGram", Display = "کیلوگرم", OrderNum = 9 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Mass:Gram", Display = "گرم", OrderNum = 8 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Mass:MilliGram", Display = "میلی‌گرم", OrderNum = 7 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Length:KiloMeter", Display = "کیلومتر", OrderNum = 12 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Length:Meter", Display = "متر", OrderNum = 11 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Length:CentiMeter", Display = "سانتی‌متر", OrderNum = 11 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Length:MilliMeter", Display = "میلی‌متر", OrderNum = 11 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Space:SquareMeter", Display = "مترمربع", OrderNum = 13 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Space:SquareCentiMeter", Display = "سانتی‌مترمربع", OrderNum = 14 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Volume:CubicMeter", Display = "مترمکعب", OrderNum = 14 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Volume:CubicCentiMeter", Display = "سانتی‌مترمکعب", OrderNum = 14 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Volume:Litre", Display = "لیتر", OrderNum = 15 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Angle:Radian", Display = "رادیان", OrderNum = 2 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Angle:Degree", Display = "درجه", OrderNum = 2 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Angle:Grad", Display = "گراد", OrderNum = 2 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Temperature:Kelvin", Display = "کلوین", OrderNum = 2 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Temperature:Celsius", Display = "سلسیوس", OrderNum = 2 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Temperature:Fahrenheit", Display = "فارنهایت", OrderNum = 2 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Power:KiloWatt", Display = "کیلووات", OrderNum = 2 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Power:Watt", Display = "وات", OrderNum = 2 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Energy:KiloWatt.Hour", Display = "کیلووات ساعت", OrderNum = 2 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Energy:Watt.Hour", Display = "وات ساعت", OrderNum = 2 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Density:KiloGram/CubicMeter", Display = "کیلوگرم بر مترمکعب", OrderNum = 9 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Density:Gram/CubicCentiMeter", Display = "گرم بر سانتی‌مترمکعب", OrderNum = 9 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Density:PPM", Display = "قسمت در میلیون", OrderNum = 16 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Money:Rial", Display = "ریال", OrderNum = 3 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Money:KRial", Display = "هزار ریال", OrderNum = 3 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Money:MRial", Display = "میلیون ریال", OrderNum = 3 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Money:GRial", Display = "میلیارد ریال", OrderNum = 3 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Money:TRial", Display = "هزار میلیارد ریال", OrderNum = 3 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Money:Euro", Display = "یورو", OrderNum = 4 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Money:KEuro", Display = "هزار یورو", OrderNum = 4 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Money:MEuro", Display = "میلیون یورو", OrderNum = 4 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Money:GEuro", Display = "میلیارد یورو", OrderNum = 4 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Money:Dollar", Display = "دلار", OrderNum = 5 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Money:KDollar", Display = "هزار دلار", OrderNum = 5 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Money:MDollar", Display = "میلیون دلار", OrderNum = 5 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Money:GDollar", Display = "میلیارد دلار", OrderNum = 5 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Money:Dirham", Display = "درهم", OrderNum = 6 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Money:KDirham", Display = "هزار درهم", OrderNum = 5 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Money:MDirham", Display = "میلیون درهم", OrderNum = 5 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Money:GDirham", Display = "میلیارد درهم", OrderNum = 5 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Man.Hour/PTon", Display = "نفر ساعت بر تن تولید", OrderNum = 2 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Man.Hour/PTonRecycle", Display = "نفر ساعت بر تن اسیدبازیافتی", OrderNum = 2 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Ton/Hour", Display = "تن بر ساعت", OrderNum = 15 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Ton/Minute", Display = "تن بر دقیقه", OrderNum = 15 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "KiloGram/Ton", Display = "کیلوگرم بر تن", OrderNum = 9 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "KiloGram/PTon", Display = "کیلوگرم بر تن تولید", OrderNum = 9 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "KiloGram/PTonRecycle", Display = "کیلوگرم بر تن تولید اسیدبازیافتی", OrderNum = 9 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Gram/SquareMeter", Display = "گرم بر مترمربع", OrderNum = 16 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "MilliGram/Litre", Display = "میلی‌گرم بر لیتر", OrderNum = 15 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Meter/Ton", Display = "متر بر تن", OrderNum = 11 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "MilliMeter/Ton", Display = "میلی‌متر بر تن", OrderNum = 11 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "CubicMeter/Litre", Display = "مترمکعب بر لیتر", OrderNum = 15 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "CubicMeter/PTon", Display = "مترمکعب بر تن تولید", OrderNum = 14 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "CubicMeter/PTonRecycle", Display = "مترمکعب بر تن تولید اسیدبازیافتی", OrderNum = 14 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Litre/Hour", Display = "لیتر بر ساعت", OrderNum = 15 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Litre/Second", Display = "لیتر بر ثانیه", OrderNum = 15 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Litre/PTon", Display = "لیتر بر تن تولید", OrderNum = 15 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Litre/PTonRecycle", Display = "لیتر بر تن اسید بازیافتی", OrderNum = 15 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "KiloWatt.Hour/PTon", Display = "کیلووات ساعت بر تن تولید", OrderNum = 2 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "KiloWatt.Hour/PTonRecycle", Display = "کیلووات ساعت بر تن اسیدبازیافتی", OrderNum = 2 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Rial/Ton", Display = "ریال بر تن", OrderNum = 3 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Rial/PTon", Display = "ریال بر تن تولید", OrderNum = 3 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Rial/PTonRecycle", Display = "ریال بر تن تولید اسیدبازیافتی", OrderNum = 3 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "KRial/Ton", Display = "هزار ریال بر تن", OrderNum = 3 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "KRial/PTon", Display = "هزار ریال بر تن تولید", OrderNum = 3 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "KRial/PTonRecycle", Display = "هزار ریال بر تن تولید اسیدبازیافتی", OrderNum = 3 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "MRial/Ton", Display = "میلیون ریال بر تن", OrderNum = 3 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Mial/PTon", Display = "میلیون ریال بر تن تولید", OrderNum = 3 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Mial/PTonRecycle", Display = "میلیون ریال بر تن تولید اسیدبازیافتی", OrderNum = 3 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Dollar/Ton", Display = "دلار بر تن", OrderNum = 3 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Dollar/PTon", Display = "دلار بر تن تولید", OrderNum = 3 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "Dollar/PTonRecycle", Display = "دلار بر تن تولید اسیدبازیافتی", OrderNum = 3 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "KDollar/Ton", Display = "هزار دلار بر تن", OrderNum = 3 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "KDollar/PTon", Display = "هزار دلار بر تن تولید", OrderNum = 3 });
                    lookUpValue.Add(new LookUpValue { FkLookUpId = lookup.Id, Value = "KDollar/PTonRecycle", Display = "هزار دلار بر تن تولید اسیدبازیافتی", OrderNum = 3 });
                    context.LookUpValues.AddRange(lookUpValue);
                    //------------------------------------
                    context.SaveChanges();
                    lookUpDestination.Clear();
